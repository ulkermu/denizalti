...
function cacheBustTask() {
	...
	return src(['index.html','gallery.html','contact.html', 'announcement.html', 'nutrition.html', 'whoAreWe.html', 'whatAreWeDoing.html', 'class-second.html', 'class-third.html', 'class-fourth.html', 'class-fifth.html'])
...
function bsWatchTask() {
	watch(['index.html', 'gallery.html', 'contact.html', 'announcement.html', 'nutrition.html', 'whoAreWe.html', 'whatAreWeDoing.html', 'class-second.html', 'class-third.html', 'class-fourth.html', 'class-fifth.html'], browserSyncReload);
	watch(
		[files.scssPath, files.jsPath],
		{ interval: 1000, usePolling: true }, //Makes docker work
